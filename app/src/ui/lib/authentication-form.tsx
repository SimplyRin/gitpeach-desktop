...
export const BrowserRedirectMessage =
  "Your browser will redirect you back to GitPeach Desktop once you've signed in. If your browser asks for your permission to launch GitPeach Desktop please allow it to."
